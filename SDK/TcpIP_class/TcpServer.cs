                    ...
                    else // mode classique
                    {
                        ...
                        switch (myClient.Command)
                        {
                            ...
                            #region Door
                                    ...
                                    (localDeviceArray[0].rfidDev.DeviceStatus == DeviceStatus.DS_Ready))
                                {
                                    try
                                    {
                                        if (CryptedAuthorization == "PwdForUnlock")
                                        {
                                            localDeviceArray[0].rfidDev.get_RFID_Device.OpenDoor();
                                            SendReturnCode(mySocket, myClient, ReturnType.UnlockDoorOK, false);
                                        }
                                        else
                                        {
                                            byte[] pwd = tcpUtils.GetPasswordBytes(tcpUtils.ConvertToSecureString(Environment.MachineName));
                                            string Decrypt = tcpUtils.Decrypt(CryptedAuthorization, pwd);
                                            if (Decrypt == Environment.MachineName)
                                            {
                                                localDeviceArray[0].rfidDev.get_RFID_Device.OpenDoor();
                                                SendReturnCode(mySocket, myClient, ReturnType.UnlockDoorOK, false);
                                            }
                                            ...
                                            {
                                                SendReturnCode(mySocket, myClient, ReturnType.FunctionNotAuthorized, false);
                                            }
                                        }
                                ...
                                if ((localDeviceArray[0].rfidDev.ConnectionStatus == ConnectionStatus.CS_Connected) &&
                                    ((localDeviceArray[0].rfidDev.DeviceStatus == DeviceStatus.DS_DoorOpen) || localDeviceArray[0].rfidDev.DeviceStatus == DeviceStatus.DS_Ready))
                                {
                                    try
                                    {
                                        ...
                                        if (CryptedAuthorization == "PwdForUnlock")
                                        {
                                            localDeviceArray[0].rfidDev.get_RFID_Device.CloseDoor();
                                            SendReturnCode(mySocket, myClient, ReturnType.lockDoorOK, false);
                                        }
                                        else
                                        {
                                            byte[] pwd =
                                                tcpUtils.GetPasswordBytes(
                                                    tcpUtils.ConvertToSecureString(Environment.MachineName));
                                            string Decrypt = tcpUtils.Decrypt(CryptedAuthorization, pwd);
                                            if (Decrypt == Environment.MachineName)
                                            {
                                                localDeviceArray[0].rfidDev.get_RFID_Device.CloseDoor();
                                            ...
                                            {
                                                SendReturnCode(mySocket, myClient, ReturnType.FunctionNotAuthorized,
                                                    false);
                                            }
                                        }
                                    }
                            ...
                            case "SCAN?":
                                {
                                    ...
                                    if (nbArg == 1) // unique reader assume in index  0 of local array
                                    {
                                        ...
                                        if (localDeviceArray[0].rfidDev.get_RFID_Device.UserActionPending)
                                        {
                                        ...
                                        else
                                        {
                                                ...
                                                if ((localDeviceArray[0].rfidDev.ConnectionStatus ==
                                                     ConnectionStatus.CS_Connected) &&
                                                    (localDeviceArray[0].rfidDev.DeviceStatus == DeviceStatus.DS_Ready))
                                                {
                                                    localDeviceArray[0].rfidDev.get_RFID_Device.TCPActionPending = true;
                                    ...
                                    else
                                    {
                                        ...
                                        foreach (deviceClass dc in localDeviceArray)
                                        {
                                            if (dc.infoDev.SerialRFID.Equals(serialRFID))
                                            {
                                                ...
                                                if (dc.rfidDev.get_RFID_Device.UserActionPending)
                                                {
                                                    SendReturnCode(mySocket, myClient, ReturnType.failedToStartScan, false);
                                                }
                                                else
                                                {
                                                    ...
                                                    {
                                                        dc.rfidDev.get_RFID_Device.TCPActionPending = true;
                        ...
                        case "GET_FANEM_INFO?":
                                ...
                                case "GET_LAST_BADGE?":
                            {
                                ...
                                if (localDeviceArray[0].infoDev.deviceType == DeviceType.DT_SMC)
                                    LastBadgeRead = localDeviceArray[0].myMedicalCabinet.Rs232Module.LastBadgeRead;
                                if (localDeviceArray[0].infoDev.deviceType == DeviceType.DT_SBF)
                                    LastBadgeRead = localDeviceArray[0].myFridgeCabinet.Rs232Module.LastBadgeRead;
                                if (localDeviceArray[0].infoDev.deviceType == DeviceType.DT_SFR)
                                    LastBadgeRead = localDeviceArray[0].myFridgeCabinet.Rs232Module.LastBadgeRead;
